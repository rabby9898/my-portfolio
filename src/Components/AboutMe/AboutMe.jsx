  ...
  return (
    <>
      ...
      <div className="w-full md:w-[800px] lg:w-[1280px] px-5 md:px-10 lg:px-20 py-5 flex justify-between gap-5 md:10 lg:gap-20 items-center mx-auto">
        <div className="w-1/2">
          <img className="w-full h-[700px]" src={aboutSvg} alt="" />
        </div>
        <div className="w-1/2">
          <div className="w-full border border-white bg-white rounded-sm">
            <h1 className="text-5xl font-bold text-gray-900 uppercase my-6 text-center">
              About <span className="font-normal text-gray-600">Me</span>
            </h1>
            <p className="text-lg text-gray-400 p-10 text-justify">
